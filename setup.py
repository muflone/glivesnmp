...
from glivesnmp.functions import recursive_glob
...
setup(
    ...
    license='GPL v2',
    scripts=['glivesnmp.py'],
    packages=['glivesnmp', 'glivesnmp.models', 'glivesnmp.ui'],
    data_files=[
        ('share/glivesnmp/data', ['data/glivesnmp.png']),
        ('share/applications', ['data/glivesnmp.desktop']),
        ('share/doc/glivesnmp', list(chain(glob('doc/*'), glob('*.md')))),
        ('share/glivesnmp/ui', glob('ui/*')),
    ],
    cmdclass={
